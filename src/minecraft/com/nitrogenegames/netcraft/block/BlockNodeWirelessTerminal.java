...
public class BlockNodeWirelessTerminal extends Block {



public BlockNodeWirelessTerminal(int par1, String texture) {
...
//drops when broken with pickaxe
	...
	{
		return Netcraft.wirelessitemterminal.blockID;
	}
